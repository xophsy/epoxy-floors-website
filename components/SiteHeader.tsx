  ...
  return (
    <>
      ...
      >
        <nav
          className={cx(
            "content-shell grid grid-cols-[auto_1fr_auto] md:flex md:justify-between min-h-[2rem] items-center overflow-visible rounded-[1.75rem] px-4 py-2 md:px-6",
        ...
        >
          <Link href="/" className="flex items-center gap-0 overflow-visible" onClick={handleLogoClick}>
            ...
            <Image
              ...
              width={400}
              height={150}
              className="h-36 w-auto object-left object-contain mix-blend-screen -ml-12 translate-y-2"
            />
          </Link>
